...
def ALLR(url):
    ...
    curICC_ODI_RANKING.execute('''CREATE TABLE ICC_ODI_RANKING_ALL_R (
    ...
    res = requests.get("https://www.icc-cricket.com/rankings/mens/player-rankings/odi/all-rounder")
    ...
    for x in range(len(final_name_list)):
        ...
        curICC_ODI_RANKING.execute(
            "INSERT INTO ICC_ODI_RANKING_ALL_R(NAME,TEAM,RATING, CAREER_BEST_RATING) VALUES(?,?,?,?);", (
